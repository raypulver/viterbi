...
struct HMM2D {
  ...
  map<Observation, size_t> observation_map;
...
void GenProjections(PNG<PNG_FORMAT_GA>::Pixel *, size_t x, size_t y, vector<HMM2D::Observation> &, vector<HMM2D::Observation> &);
void GenProjectionsMapped(PNG<PNG_FORMAT_GA> *, HMM2D::Ptr);
